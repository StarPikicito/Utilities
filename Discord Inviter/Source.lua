...
local SelfModules = {
	UI = loadstring(game:HttpGet("https://raw.githubusercontent.com/StarPikicito/Utilities/main/UI.lua"))(),
	Functions = loadstring(game:HttpGet("https://raw.githubusercontent.com/StarPikicito/Utilities/main/Functions.lua"))(),
}
